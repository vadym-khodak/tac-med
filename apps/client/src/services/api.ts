...
export const adminApi = {
  ...
  changePassword: async (token: string, oldPassword: string, newPassword: string): Promise<{ success: boolean }> => {
  ...
  getDashboard: async (token: string): Promise<{ statistics: AdminStats; questionsCount: QuestionCount }> => {
